...
async function downloadM3u8(data, id, token) {
  ...
  for (let i = 0; i < data.segments.length; i++) {
    ...
    file = await uploadImageToDiscord(segment.uri);
    console.log(file);
    while (!file["success"]) {
      console.log(
...
app.get("/downloadM3u8", (req, res) => {
  if (req.query.auth != process.env.AUTH || "Dhruv@2015")
    return res.status(403).send({ status: "unauthorised" });
  if (!req.query.id)
...
uploadImageToDiscord(
  "https://c-an-ca4.betterstream.cc:2223/hls--1-f3-v1-a1.ts",
  botToken[0]
);